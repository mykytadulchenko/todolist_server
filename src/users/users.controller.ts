...
export class UsersController {
    ...
    @ApiResponse({ status: 201, description: 'Returns JWT auth token in Authorization header on success, token\\`s payload object includes user\\`s "id" and "login" fields' })
    @Post('sign-in')
